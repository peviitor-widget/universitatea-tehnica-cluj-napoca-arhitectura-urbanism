...
**Facultate:** arhitectura si urbanism

**Pagina widgetului:** https://peviitor-widget.github.io/universitatea-tehnica-cluj-napoca-arhitectura-urbanism/

Copiază codul de mai jos în pagina site-ului facultății, acolo unde vrei să apară widgetul:

```html
<iframe
  src="https://peviitor-widget.github.io/universitatea-tehnica-cluj-napoca-arhitectura-urbanism/#/widget?title=Joburi+pentru+studenti&color=%234f46e5"
  width="100%"
  height="650px"
